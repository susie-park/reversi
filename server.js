...
io.sockets.on('connection', function (socket) {
      ...
      */
      socket.on('invite',function(payload){
          ...
          if(!roomObject.sockets.hasOwnProperty(requested_user)){
            var error_message = 'invite requsted a user that wasn\'t in the room, command aborted';
            log(error_message);
            socket.emit('invite_response', {
                                                  result: 'fail',
                                                  message: error_message
      ...
      */
      socket.on('play_token',function(payload){
          ...
          if(('undefined' === typeof color) || !color || (color != 'green' && color != 'pink')){
...
function send_game_update(socket, game_id, message){
  ...
  if((games[game_id].player_green.socket != socket.id) && (games[game_id].player_pink.socket != socket.id)){
      console.log('Player isn\'t assigned a color: '+socket.id);
      /* and there isn't a color to give them */
      if((games[game_id].player_pink.socket != '') && (games[game_id].player_green.socket != '')){
          games[game_id].player_green.socket = '';
          games[game_id].player_green.username = '';
          games[game_id].player_pink.socket = '';
          games[game_id].player_pink.username = '';
